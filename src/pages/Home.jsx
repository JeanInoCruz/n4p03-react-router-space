...
export default function Home() {
  return (
    <div className="pt-6 md:pt-10 h-screen w-screen bg-home-mobile md:bg-home-tablet lg:bg-home-desktop bg-cover overflow-x-clip">
      <div className=" absolute lg:bottom-32  md:h-[343px] mt-6 md:mt-10 lg:mt-40 flex flex-col gap-20 lg:flex-row items-center justify-between max-w-[1440px] md:mx-40 mx-auto px-6 lg:px-0 md:px-24">
        <div className="flex flex-col 2gap-6 text-center lg:text-left font-Barlow+Condensed text-gray-400 w-full lg:w-[38%]">
          ...
          <p className="lg:min-w-[540px] font-Barlow text-[0.9rem] md:text-base lg:text-lg leading-8">
